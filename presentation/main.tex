    ...
    \begin{columns}[T] % T aligns columns at the top
        ...
        \begin{column}{0.48\textwidth}
            ...
            \begin{itemize}
                ...
                \par $\to {\mathbf{\tilde{w}_i \approx 1}}$
                \vspace{1em}
                \item[] Sample $z_j$ is \textbf{Bad}
                \par $\to p(x,z_j)$ is Low
                \par $\to {\mathbf{\tilde{w}_j \approx 0}}$
            \end{itemize}
        \end{column}
    \end{columns}
...
\begin{frame}{Experimental Setup}
    ...
    \begin{table}[h]
        ...
        \begin{tabular}{c|c}
            ...
            Encoder & MLP ($784 \to 200 \to 200 \to 50$) \\
            Decoder & MLP ($50 \to 200 \to 200 \to 784$) \\
...
\begin{frame}{Result 3: Impact of K on Training Time}
    \begin{columns}
...
\begin{frame}{Result 4: Sample Quality}
    \begin{columns}
        \column{0.45\textwidth}
        \centering
        \textbf{VAE (K=1)} \\
        \includegraphics[width=0.5\textwidth]{pic/vae_sample.png}
        
        \column{0.45\textwidth}
        \centering
        \textbf{IWAE (K=50)} \\
        \includegraphics[width=0.5\textwidth]{pic/iwae_sample.png}
    \end{columns}
...
\begin{frame}{Trade-offs Summary}
    \begin{table}[htbp]
        ...
        \begin{tabular}{l|c|c}
             \toprule
             \textbf{Metric} & \textbf{VAE (K=1)} & \textbf{IWAE (K=50)} \\
             \midrule
             Bound Tightness & Loose & \textbf{Tight} \\
             Latent Usage & Risk of Collapse & \textbf{Rich} \\
             Bound Variance & High & \textbf{Low} \\
             Encoder Gradient SNR & \textbf{High} & Low \\
             Sample Quality & Blurry & \textbf{Sharp} \\
